...
const CollapsibleRow: React.FC<Props> = ({
  ...
  return (
    <div className={className}>
      <div className="flex items-center" onClick={() => onCollapse(idx)}>
        <div className="flex flex-none w-8 items-center sm:hidden">
          <div className="flex justify-center items-center rounded-full border border-[#3E75FC] p-1">
        ...
        <div className="flex-1 w-32 sm:flex-none sm:w-5/12 ">{name}</div>
